...
echo 'pinned: [
  ...
  "dkml-base-compiler.4.14.0~v1.2.1~prerel12"
  "dkml-build-desktop.1.2.1~prerel12"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-env.1.2.1~prerel12"
  "dkml-compiler-src.1.2.1~prerel12"
  "dkml-component-common-desktop.1.2.1~prerel12"
  "dkml-component-common-opam.2.2.0~alpha0~20221228"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-network-ocamlcompiler.4.14.0~v1.2.1~prerel12"
  "dkml-component-ocamlcompiler-common.4.14.0~v1.2.1~prerel12"
  "dkml-component-ocamlcompiler-network.4.14.0~v1.2.1~prerel12"
  "dkml-component-offline-desktop-full.1.2.1~prerel12"
  "dkml-component-offline-opamshim.2.2.0~alpha0~20221228"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.1.2.1~prerel12"
  ...
  "dkml-runtime-distribution.1.2.1~prerel12"
  "dkml-runtimelib.1.2.1~prerel12"
  "dkml-runtimescripts.1.2.1~prerel12"
  "dkml-workflows.1.2.1~prerel12"

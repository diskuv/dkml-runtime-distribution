...
echo 'pinned: [
  ...
  "diskuvbox.0.2.0"
  "dkml-apps.2.0.2"
  "dkml-base-compiler.4.14.0~v2.0.2"
  "dkml-build-desktop.2.0.2"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-env.2.0.2"
  "dkml-compiler-src.2.0.2"
  "dkml-component-common-desktop.2.0.2"
  ...
  "dkml-component-staging-desktop-full.2.0.2"
  "dkml-component-staging-dkmlconfdir.2.0.2"
  "dkml-component-staging-ocamlrun.4.14.0~v2.0.2"
  ...
  "dkml-component-staging-withdkml.2.0.2"
  ...
  "dkml-install.0.5.0"
  "dkml-installer-ocaml-common.2.0.2"
  "dkml-installer-ocaml-network.2.0.2"
  "dkml-installer-ocaml-offline.2.0.2"
  "dkml-package-console.0.5.0"
  "dkml-runtime-common-native.2.0.2"
  "dkml-runtime-common.2.0.2"
  "dkml-runtime-distribution.2.0.2"
  "dkml-runtimelib.2.0.2"
  "dkml-runtimescripts.2.0.2"
  "dkml-workflows.2.0.2"

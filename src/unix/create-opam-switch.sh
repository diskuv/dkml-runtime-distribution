...
echo 'pinned: [
  ...
  "dkml-build-desktop.1.2.1~prerel10"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-env.1.2.1~prerel10"
  "dkml-compiler-src.v1.2.1~prerel10"
  "dkml-component-common-desktop.1.2.1~prerel10"
  "dkml-component-common-opam.2.2.0~alpha0~20221228"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-network-ocamlcompiler.4.14.0~v1.2.1~prerel10"
  "dkml-component-offline-desktop-full.1.2.1~prerel10"
  "dkml-component-offline-opamshim.2.2.0~alpha0~20221228"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.1.2.1~prerel10"
  "dkml-component-staging-dkmlconfdir.1.2.1~prerel10"
  "dkml-component-staging-ocamlrun.4.14.0~v1.2.1~prerel10"
  ...
  "dkml-component-staging-withdkml.1.2.1~prerel10"
  ...
  "dkml-install.0.4.0"
  "dkml-installer-network-ocaml.1.2.1~prerel10"

...
echo 'pinned: [
  ...
  "diskuvbox.0.2.0"
  "dkml-apps.2.1.0"
  "dkml-base-compiler.4.14.0~v2.1.0"
  "dkml-build-desktop.2.1.0"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-src.2.1.0"
  "dkml-component-common-desktop.2.1.0"
  "dkml-component-common-opam.2.2.0~alpha3~20230918"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-ocamlcompiler-common.4.14.0~v2.1.0"
  "dkml-component-ocamlcompiler-network.4.14.0~v2.1.0"
  "dkml-component-ocamlcompiler-offline.4.14.0~v2.1.0"
  "dkml-component-offline-desktop-full.2.1.0"
  "dkml-component-offline-opamshim.2.2.0~alpha3~20230918"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.2.1.0"
  "dkml-component-staging-dkmlconfdir.2.1.0"
  "dkml-component-staging-ocamlrun.4.14.0~v2.1.0"
  ...
  "dkml-install.0.5.2"
  "dkml-installer-ocaml-common.2.1.0"
  "dkml-installer-ocaml-network.2.1.0"
  "dkml-installer-ocaml-offline.2.1.0"
  "dkml-package-console.0.5.2"
  "dkml-runtime-common-native.2.1.0"
  "dkml-runtime-common.2.1.0"
  "dkml-runtime-distribution.2.1.0"
  "dkml-runtimelib.2.1.0"
  "dkml-runtimescripts.2.1.0"
  "dkml-workflows.2.1.0"
  "dune-action-plugin.3.11.1"

...
echo 'pinned: [
  ...
  "csexp.1.5.2"
  "cstruct.6.2.0"
  "ctypes-foreign.0.19.2-windowssupport-r7"
  "ctypes.0.19.2-windowssupport-r7"
  "cudf.0.10"
  "digestif.1.1.4"
  "diskuvbox.0.2.0"
  "dkml-apps.2.0.3"
  "dkml-base-compiler.4.14.0~v2.0.3"
  "dkml-build-desktop.2.0.3"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-env.2.0.3"
  "dkml-compiler-src.2.0.3"
  "dkml-component-common-desktop.2.0.3"
  "dkml-component-common-opam.2.2.0~alpha0~20221228"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-ocamlcompiler-common.4.14.0~v2.0.3"
  "dkml-component-ocamlcompiler-network.4.14.0~v2.0.3"
  "dkml-component-ocamlcompiler-offline.4.14.0~v2.0.3"
  "dkml-component-offline-desktop-full.2.0.3"
  "dkml-component-offline-opamshim.2.2.0~alpha0~20221228"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.2.0.3"
  "dkml-component-staging-dkmlconfdir.2.0.3"
  "dkml-component-staging-ocamlrun.4.14.0~v2.0.3"
  ...
  "dkml-component-staging-withdkml.2.0.3"
  "dkml-component-xx-console.0.1.1"
  "dkml-exe-lib.2.0.3"
  "dkml-exe.2.0.3"
  "dkml-install-installer.0.5.1"
  "dkml-install-runner.0.5.1"
  "dkml-install.0.5.1"
  "dkml-installer-ocaml-common.2.0.3"
  "dkml-installer-ocaml-network.2.0.3"
  "dkml-installer-ocaml-offline.2.0.3"
  "dkml-package-console.0.5.1"
  "dkml-runtime-common-native.2.0.3"
  "dkml-runtime-common.2.0.3"
  "dkml-runtime-distribution.2.0.3"
  "dkml-runtimelib.2.0.3"
  "dkml-runtimescripts.2.0.3"
  "dkml-workflows.2.0.3"

...
echo 'pinned: [
  ...
  "diskuvbox.0.2.0"
  "dkml-apps.2.1.4"
  "dkml-base-compiler.4.14.2~v2.1.4"
  "dkml-build-desktop.2.1.4"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-src.2.1.4"
  "dkml-component-common-desktop.2.1.4"
  "dkml-component-common-opam.2.2.1"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-ocamlcompiler-common.4.14.2~v2.1.4"
  "dkml-component-ocamlcompiler-network.4.14.2~v2.1.4"
  "dkml-component-ocamlcompiler-offline.4.14.2~v2.1.4"
  "dkml-component-offline-desktop-full.2.1.4"
  "dkml-component-offline-opamshim.2.2.1"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.2.1.4"
  "dkml-component-staging-dkmlconfdir.2.1.4"
  "dkml-component-staging-ocamlrun.4.14.2~v2.1.4"
  "dkml-component-staging-opam32.2.2.1"
  "dkml-component-staging-opam64.2.2.1"
  "dkml-component-staging-unixutils.0.2.0"
  "dkml-component-staging-withdkml.2.1.4"
  ...
  "dkml-install.0.5.3"
  "dkml-installer-ocaml-common.2.1.4"
  "dkml-installer-ocaml-network.2.1.4"
  "dkml-installer-ocaml-offline.2.1.4"
  "dkml-option-bx32.1"
  "dkml-package-console.0.5.3"
  "dkml-runtime-common-native.2.1.1"
  "dkml-runtime-common.2.1.4"
  "dkml-runtime-distribution.2.1.4"
  "dkml-runtimelib.2.1.4"
  "dkml-runtimescripts.2.1.4"
  "dkml-workflows.2.1.4"

...
echo 'pinned: [
  ...
  "diskuvbox.0.2.0"
  "dkml-apps.2.0.1"
  "dkml-base-compiler.4.14.0~v2.0.1"
  "dkml-build-desktop.2.0.1"
  "dkml-c-probe.3.0.0"
  "dkml-compiler-env.2.0.1"
  "dkml-compiler-src.2.0.1"
  "dkml-component-common-desktop.2.0.1"
  "dkml-component-common-opam.2.2.0~alpha0~20221228"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-ocamlcompiler-common.4.14.0~v2.0.1"
  "dkml-component-ocamlcompiler-network.4.14.0~v2.0.1"
  "dkml-component-offline-desktop-full.2.0.1"
  "dkml-component-offline-opamshim.2.2.0~alpha0~20221228"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.2.0.1"
  "dkml-component-staging-dkmlconfdir.2.0.1"
  "dkml-component-staging-ocamlrun.4.14.0~v2.0.1"
  ...
  "dkml-component-staging-withdkml.2.0.1"
  ...
  "dkml-installer-offline-ocaml.2.0.1"
  "dkml-package-console.0.4.0"
  "dkml-runtime-common-native.2.0.1"
  "dkml-runtime-common.2.0.1"
  "dkml-runtime-distribution.2.0.1"
  "dkml-runtimelib.2.0.1"
  "dkml-runtimescripts.2.0.1"
  "dkml-workflows.2.0.1"
